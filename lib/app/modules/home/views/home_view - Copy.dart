...
import 'package:medicalsupport/config/category_card.dart';
//import 'package:medicalsupport/app/modules/home/views/selected_category.dart';
import 'package:medicalsupport/app/modules/home/views/all_category_view.dart';
import 'package:medicalsupport/app/modules/home/views/all_artist_view.dart';
...
class _HomeViewState extends State<HomeView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Medical Support', style: TextStyle(fontSize: 20)),
        centerTitle: true,
