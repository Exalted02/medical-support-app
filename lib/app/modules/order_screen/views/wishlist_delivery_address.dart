...
import 'package:medicalsupport/app/modules/order_screen/views/card_payment_screen.dart';

import 'package:medicalsupport/app/modules/profile_screen/controllers/user_controller.dart';
import '../controllers/order_controller.dart';

class WishlistDeliveryAddressPage extends StatefulWidget {
  @override
  _WishlistDeliveryAddressPageState createState() => _WishlistDeliveryAddressPageState();
}

class _WishlistDeliveryAddressPageState extends State<WishlistDeliveryAddressPage> {
                    ...
                    onPress: orderController.isDAloading.value
                        ...
                        : () {
                            if (_formKey.currentState!.validate()) {
                              orderController.payNowWishlist(orderId);
                            } else {}
                          },
                  );
                }),
